...
class Configuration
{
     ...
     * @var string
     */
    protected $userAgent = 'klaviyo/api-beta/2.0.0';
    ...
    {
        $report  = 'PHP SDK (KlaviyoAPIBeta) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 2022-12-15.pre' . PHP_EOL;
