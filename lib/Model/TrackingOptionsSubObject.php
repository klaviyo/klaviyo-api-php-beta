...
class TrackingOptionsSubObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets utm_params
     *
     * @param \KlaviyoAPIBeta\Model\UTMParamsSubObject[]|null $utm_params A list of UTM parameters. If an empty list is given and is_add_utm is True, company defaults will be used.
     *
     * @return self
     */
