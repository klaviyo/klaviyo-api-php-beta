...
class MetricsApi
{
    ...
    /**
     * Operation getMetricAggregate
     *
     * Get Metric Aggregate
     *
     * @param  \KlaviyoBeta\Model\MetricAggregateQuery $metric_aggregate_query Retrieve Metric Aggregations (required)
     *
     * @throws \KlaviyoBeta\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array<string,mixed>|\KlaviyoBeta\Model\GetCatalogItems400Response|\KlaviyoBeta\Model\GetCatalogItems400Response
     */
    public function getMetricAggregate($metric_aggregate_query, $apiKey = null)
    {
        list($response) = $this->getMetricAggregateWithHttpInfo($metric_aggregate_query, $apiKey);
        return $response;
    }

    /**
     * Operation getMetricAggregateWithHttpInfo
     *
     * Get Metric Aggregate
     *
     * @param  \KlaviyoBeta\Model\MetricAggregateQuery $metric_aggregate_query Retrieve Metric Aggregations (required)
     ...
     * @return array of array<string,mixed>|\KlaviyoBeta\Model\GetCatalogItems400Response|\KlaviyoBeta\Model\GetCatalogItems400Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getMetricAggregateWithHttpInfo($metric_aggregate_query, $apiKey = null)
    {
        $request = $this->getMetricAggregateRequest($metric_aggregate_query, $apiKey);
    ...
    /**
     * Operation getMetricAggregateAsync
     *
     * Get Metric Aggregate
     *
     * @param  \KlaviyoBeta\Model\MetricAggregateQuery $metric_aggregate_query Retrieve Metric Aggregations (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getMetricAggregateAsync($metric_aggregate_query, $apiKey = null)
    {
        return $this->getMetricAggregateAsyncWithHttpInfo($metric_aggregate_query, $apiKey)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getMetricAggregateAsyncWithHttpInfo
     *
     * Get Metric Aggregate
     *
     * @param  \KlaviyoBeta\Model\MetricAggregateQuery $metric_aggregate_query Retrieve Metric Aggregations (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getMetricAggregateAsyncWithHttpInfo($metric_aggregate_query, $apiKey = null)
    {
        $returnType = 'array<string,mixed>';
        $request = $this->getMetricAggregateRequest($metric_aggregate_query, $apiKey);
    ...
    /**
     * Create request for operation 'getMetricAggregate'
     *
     * @param  \KlaviyoBeta\Model\MetricAggregateQuery $metric_aggregate_query Retrieve Metric Aggregations (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getMetricAggregateRequest($metric_aggregate_query, $apiKey = null)
    {
        ...
        if ($metric_aggregate_query === null || (is_array($metric_aggregate_query) && count($metric_aggregate_query) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $metric_aggregate_query when calling getMetricAggregate'
            );
        }
     ...
     * @return array<string,mixed>|\KlaviyoBeta\Model\GetCatalogItems400Response|\KlaviyoBeta\Model\GetCatalogItems400Response
     */
    public function getMetrics($fields_metric = null, $page_cursor = null, $apiKey = null)
    {
        list($response) = $this->getMetricsWithHttpInfo($fields_metric, $page_cursor, $apiKey);
        return $response;
    }
     ...
     * @return array of array<string,mixed>|\KlaviyoBeta\Model\GetCatalogItems400Response|\KlaviyoBeta\Model\GetCatalogItems400Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getMetricsWithHttpInfo($fields_metric = null, $page_cursor = null, $apiKey = null)
    {
        $request = $this->getMetricsRequest($fields_metric, $page_cursor, $apiKey);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getMetricsAsync($fields_metric = null, $page_cursor = null, $apiKey = null)
    {
        return $this->getMetricsAsyncWithHttpInfo($fields_metric, $page_cursor, $apiKey)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getMetricsAsyncWithHttpInfo($fields_metric = null, $page_cursor = null, $apiKey = null)
    {
        $returnType = 'array<string,mixed>';
        $request = $this->getMetricsRequest($fields_metric, $page_cursor, $apiKey);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getMetricsRequest($fields_metric = null, $page_cursor = null, $apiKey = null)
    {
