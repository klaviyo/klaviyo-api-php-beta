...
class ProfilesApi
{
     ...
     * Create Profile
     *
     * @param  \KlaviyoBeta\Model\ProfileCreateQuery $profile_create_query profile_create_query (required)
     *
     ...
     * Create Profile
     *
     * @param  \KlaviyoBeta\Model\ProfileCreateQuery $profile_create_query (required)
     *
     * @throws \KlaviyoBeta\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    {
        list($response) = $this->subscribeProfilesWithHttpInfo($subscription_create_job_create_query, $apiKey);
        return $response;
    }
     ...
     * Suppress Profiles
     *
     * @param  \KlaviyoBeta\Model\SuppressionCreateJobCreateQuery $suppression_create_job_create_query Suppresses one or more profiles from receiving marketing. Currently, supports email only. If a profile is not found with the given email, one will be created and immediately suppressed. (required)
     *
     * @throws \KlaviyoBeta\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array<string,mixed>|\KlaviyoBeta\Model\GetCatalogItems400Response|\KlaviyoBeta\Model\GetCatalogItems400Response
    ...
    {
        list($response) = $this->suppressProfilesWithHttpInfo($suppression_create_job_create_query, $apiKey);
        return $response;
    }
    ...
    {
        list($response) = $this->unsubscribeProfilesWithHttpInfo($unsubscription_create_job_create_query, $apiKey);
        return $response;
    }
     ...
     * Unsuppress Profiles
     *
     * @param  \KlaviyoBeta\Model\UnsuppressionCreateJobCreateQuery $unsuppression_create_job_create_query Unsuppresses one or more profiles from receiving marketing. Currently, supports email only. If a profile is not found with the given email, no action will be taken. (required)
     *
     * @throws \KlaviyoBeta\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array<string,mixed>|\KlaviyoBeta\Model\GetCatalogItems400Response|\KlaviyoBeta\Model\GetCatalogItems400Response
    ...
    {
        list($response) = $this->unsuppressProfilesWithHttpInfo($unsuppression_create_job_create_query, $apiKey);
        return $response;
    }
     ...
     *
     * @param  string $id  (required)
     * @param  \KlaviyoBeta\Model\ProfilePartialUpdateQuery $profile_partial_update_query profile_partial_update_query (required)
     *
     * @throws \KlaviyoBeta\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array<string,mixed>|\KlaviyoBeta\Model\GetCatalogItems400Response|\KlaviyoBeta\Model\GetCatalogItems400Response
     ...
     *
     * @param  string $id  (required)
     * @param  \KlaviyoBeta\Model\ProfilePartialUpdateQuery $profile_partial_update_query (required)
     *
     * @throws \KlaviyoBeta\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of array<string,mixed>|\KlaviyoBeta\Model\GetCatalogItems400Response|\KlaviyoBeta\Model\GetCatalogItems400Response, HTTP status code, HTTP response headers (array of strings)
